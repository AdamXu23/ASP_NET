...
using CoreMvc3_DependencyInjection.Models;
...
namespace CoreMvc3_DependencyInjection.Services
{
    public class TaiwanZipcodeService : IZipcodeService
    {
            ...
            Cities = new List<ZipcodeViewModel>
            {
                ...
                new ZipcodeViewModel {
                    ...
                    Districts = new List<District>
                    {
                        ...
                        new District { Id ="10", Name="貢寮區", Zipcode ="228"  },                        new District { Id ="01", Name="XXX區", Zipcode ="000"  },
                        new District { Id ="11", Name="新店區", Zipcode ="231"  },
                        new District { Id ="12", Name="坪林區", Zipcode ="232"  },
                        new District { Id ="13", Name="烏來區", Zipcode ="233"  },
                        new District { Id ="14", Name="永和區", Zipcode ="234"  },                        new District { Id ="01", Name="XXX區", Zipcode ="000"  },
                        new District { Id ="15", Name="中和區", Zipcode ="235"  },
                        new District { Id ="16", Name="土城區", Zipcode ="236"  },
                        new District { Id ="17", Name="三峽區", Zipcode ="237"  },
                        new District { Id ="18", Name="樹林區", Zipcode ="238"  },                        new District { Id ="01", Name="XXX區", Zipcode ="000"  },
                        ...
                        new District { Id ="24", Name="蘆洲區", Zipcode ="247"  },                        new District { Id ="01", Name="XXX區", Zipcode ="000"  },
        ...
        public string QueryZipcode(string cityName, string districtName)
        {
            ...
            {
                return "Error : Must given the City & District Name";
            }
            ...
            //2.查詢District
            District _district = _city.Districts.Where(d => d.Name.Contains(districtName)).Select(p=>p).FirstOrDefault();
            ...
            string zipcode = Cities.Where(c => c.CityName.Contains(cityName))
