...
namespace CoreMvc3_Pillars.Controllers
{
    public class ResultsController : Controller
    {
        ...
        public ResultsController(IWebHostEnvironment hostingEnvironment)
        {
        ...
        public PhysicalFileResult PhysicalFileResult()
        {
            ...
            //return new PhysicalFileResult(_hostingEnvironment.ContentRootPath + "/wwwroot/pdf/CorePDF.pdf", "application/pdf");
        }
        #endregion
